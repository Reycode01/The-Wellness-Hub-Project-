fetch('http://localhost:3000/products')
  ...
  .then(products => {
    // Filter the products array to get the first 16 products
    const limitedProducts = products.slice(0, 16);

    // Do something with the limitedProducts array, such as rendering it to the DOM
    ...
    // Post Comment Buttons
        ...
        document.addEventListener('DOMContentLoaded', function() {
            const products = [
                ...
                { name: 'Visha Skin Care', stock: 20, imageUrl: 'https://www.vishaskincare.com/cdn/shop/products/69491231_1111677412358688_7737693182166564864_o_1024x1024.jpg?v=1567043202'},
